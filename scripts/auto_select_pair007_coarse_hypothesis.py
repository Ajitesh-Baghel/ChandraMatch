...
SUMMARY_CSV = (
    OUT_DIR
    / "pair007_auto_hypothesis_summary.csv"
)

SUMMARY_JSON = (
    OUT_DIR
    / "pair007_auto_hypothesis_summary.json"
)

SELECTED_PRIOR_JSON = (
    OUT_DIR
    / "pair007_selected_prior.json"
)
...
def shape_sane(info):
    ...
    Prior validation demonstrated that a large real coarse displacement can
...
def create_candidate_prior(
    ...
    # pair007_tiled_lightglue.py specifically looks for:
...
def run_candidate(
    ...
    try:
        ...
        metrics_path = (
            candidate_dir
            / "pair007_tiled_lightglue_metrics.json"
        )
...
def save_summary(
    ...
    for name in [
        "pair007_tiled_lightglue_metrics.json",
        "pair007_tiled_lightglue_inliers.csv",
        "pair007_tiled_lightglue_matches.png",
        "console.log",
        "candidate_prior.json",
    ]:
        src = (
...
def main():
    print("=" * 90)
    print(
        "PAIR 007 — AUTOMATIC COARSE-HYPOTHESIS SELECTION"
    )
    print("=" * 90)
    ...
    print()
    print(
        "PAIR 007 AUTOMATIC COARSE-HYPOTHESIS "
        "SELECTION COMPLETE."
    )
