...
OUT_DIR = ROOT / "results" / "pair_007" / "global_benchmark"
...
def affine_sanity(info):
    """
    Pair 007 has already been map-projected onto the same 5 m grid.
...
def main():
    print("=" * 72)
    print("PAIR 007 — GLOBAL CROSS-MISSION MATCHING BENCHMARK")
    print("=" * 72)
    ...
    print("\n")
    print("=" * 72)
    print("PAIR 007 BENCHMARK SUMMARY")
    print("=" * 72)
    ...
    print("\nPAIR 007 GLOBAL BENCHMARK COMPLETE.")
