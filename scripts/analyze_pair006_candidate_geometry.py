...
CANDIDATE_CSV = (
    ...
    / "pair_006"
    / "candidate_geometry"
    / "pair006_distinct_candidates.csv"
)
...
def main():
    print("=" * 88)
    print(
        "PAIR 006 — PRE-RANSAC CANDIDATE GEOMETRY DIAGNOSIS"
    )
    print("=" * 88)
    ...
    bin_csv_path = (
        OUT_DIR
        / "pair006_candidate_geometry_bins.csv"
    )
    ...
    image_path = (
        OUT_DIR
        / "pair006_candidate_geometry.png"
    )
    ...
    json_path = (
        OUT_DIR
        / "pair006_candidate_geometry.json"
    )
    ...
    print()
    print(
        "PAIR 006 candidate geometry diagnosis complete."
    )
