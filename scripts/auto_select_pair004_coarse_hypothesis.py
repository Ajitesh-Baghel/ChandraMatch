...
SUMMARY_CSV = (
    OUT_DIR
    / "pair004_auto_hypothesis_summary.csv"
)

SUMMARY_JSON = (
    OUT_DIR
    / "pair004_auto_hypothesis_summary.json"
)

SELECTED_PRIOR_JSON = (
    OUT_DIR
    / "pair004_selected_prior.json"
)
...
def shape_sane(info):
    ...
    Pair004 demonstrated that a large real coarse displacement can
...
def create_candidate_prior(
    ...
    # pair004_tiled_lightglue.py specifically looks for:
...
def save_summary(
    ...
    for name in [
        ...
        "pair004_tiled_lightglue_matches.png",
        "console.log",
        "candidate_prior.json",
    ]:
        src = (
...
def main():
    print("=" * 90)
    print(
        "PAIR 004 — AUTOMATIC COARSE-HYPOTHESIS SELECTION"
    )
    print("=" * 90)
    ...
    print()
    print(
        "PAIR 004 AUTOMATIC COARSE-HYPOTHESIS "
        "SELECTION COMPLETE."
    )
