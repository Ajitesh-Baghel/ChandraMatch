...
OUT_DIR = ROOT / "results" / "pair_004" / "global_benchmark"
...
def affine_sanity(info):
    """
    Pair 004 has already been map-projected onto the same 5 m grid.
...
def main():
    print("=" * 72)
    print("PAIR 004 — GLOBAL CROSS-MISSION MATCHING BENCHMARK")
    print("=" * 72)
    ...
    print("\n")
    print("=" * 72)
    print("PAIR 004 BENCHMARK SUMMARY")
    print("=" * 72)
    ...
    print("\nPAIR 004 GLOBAL BENCHMARK COMPLETE.")
