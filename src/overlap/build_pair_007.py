...
NAC_PATH = (
    ...
    / "pair_007"
    / "lro_nac_isis"
    / "M185210693RE_map_5m.tif"
)

OUT = ROOT / "data" / "processed" / "pair_007" / "canonical"
...
def main():
    print("=" * 80)
    print("PAIR 007 — CANONICAL PAIR BUILDER")
    print("=" * 80)
    ...
    with rasterio.open(TMC_PATH) as tmc, rasterio.open(NAC_PATH) as nac:
        ...
        with open(
            OUT / "pair007_canonical_metadata.json",
            "w",
            encoding="utf-8",
        ) as f:
        ...
        print("\nPAIR 007 canonical build complete.")
